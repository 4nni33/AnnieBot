...
if wget -q https://github.com/4nni33/AnnieBot/raw/master/audio/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/4nni33/AnnieBot.git
